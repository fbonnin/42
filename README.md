...
<h3>push_swap</h3>
Trier des nombres avec deux piles et un jeu d'instructions limité. Ces contraintes font la difficulté du projet. Différents algorithmes de tri sont implémentés, dont le tri fusion.
